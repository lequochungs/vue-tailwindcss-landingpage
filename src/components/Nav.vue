<template>
  <nav
    v-bind:class="{
      'fixed transition-all ease-in duration-1500 w-full': sticky
    }"
  ...
  >
    ...
    <div
      ...
      class="transition duration-2000 ease-in-out w-full block flex-grow md:flex md:items-center md:w-auto md:block"
    >
      <div class="text-sm md:flex-grow">
        ...
        <a
          href="#responsive-header"
          class="block mt-4 md:inline-block md:mt-0 text-teal-200 hover:text-white"
        >
          Blog
        </a>
      </div>
